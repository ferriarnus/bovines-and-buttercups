...
public class MoobloomModel extends CowModel<Moobloom> {
    ...
    @Override
    public void setupAnim(Moobloom entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
