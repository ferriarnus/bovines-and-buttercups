...
public class BovinesCowTypeTypes {
    public static final CowTypeType<MoobloomConfiguration> MOOBLOOM_TYPE = new CowTypeType<>(MoobloomConfiguration.CODEC, BovinesCowTypes.MoobloomKeys.MISSING_MOOBLOOM, MoobloomConfiguration.DEFAULT);
    public static final CowTypeType<MooshroomConfiguration> MOOSHROOM_TYPE = new CowTypeType<>(MooshroomConfiguration.CODEC, BovinesCowTypes.MooshroomKeys.MISSING_MOOSHROOM, MooshroomConfiguration.DEFAULT);
