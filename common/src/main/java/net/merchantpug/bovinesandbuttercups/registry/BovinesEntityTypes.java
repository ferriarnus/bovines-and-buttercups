...
public class BovinesEntityTypes {
    ...
    public static final RegistryObject<EntityType<Moobloom>> MOOBLOOM = register("moobloom", () -> EntityType.Builder.of(Moobloom::new, MobCategory.CREATURE).sized(0.9F, 1.4F).clientTrackingRange(10).build(BovinesAndButtercups.asResource("moobloom").toString()));
