...
public record MooshroomConfiguration(Settings<MooshroomConfiguration> settings,
    ...
    public static final MapCodec<MooshroomConfiguration> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
            Settings.codec(BovinesCowTypeTypes.MOOSHROOM_TYPE).forGetter(MooshroomConfiguration::settings),
