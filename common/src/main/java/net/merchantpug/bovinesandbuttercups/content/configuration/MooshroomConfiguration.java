...
public record MooshroomConfiguration(Settings settings,
    ...
    public static final MooshroomConfiguration DEFAULT = new MooshroomConfiguration(new Settings(Optional.empty(), List.of(), List.of(), Optional.empty()), new BlockReference<>(Optional.empty(), Optional.empty(), Optional.of(Holder.direct(CustomMushroomType.MISSING))), Optional.of(new BackGrassConfiguration(BovinesAndButtercups.asResource("bovinesandbuttercups/mooshroom/mooshroom_mycelium"), false)), false, false);
    ...
    public static final MapCodec<MooshroomConfiguration> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
            ...
            BackGrassConfiguration.codec(BovinesAndButtercups.asResource("bovinesandbuttercups/mooshroom/mooshroom_mycelium"), false).optionalFieldOf("back_grass").forGetter(MooshroomConfiguration::backGrass),
